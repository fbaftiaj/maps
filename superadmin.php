...
<body>
    <div class="nav">
      ...
      <div class="navi">
        <div class="lis">
          <a href="superadmin.php" class="text-secondary active" ><span class="material-symbols-sharp">group</span>Zyrtarët</a>
          <a href="kom.php" class="text-secondary"><span class="material-symbols-sharp">groups</span>Kompanitë</a>
          ...
          <div class="card my-4" style="border:none;">
            <div class="card-header p-0 position-relative mt-n4  z-index-2" style="border:none;">
              <div class=" shadowi shadow-danger border-radius-lg pt-4 pb-3">
                <h5 class="text-secondary d-flex font-weight-bold text-capitalize ps-3">Zyrtarët</h5>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="tabela">
                  ...
                  <tbody>
                  <?php
                      $select = $connect->query("SELECT * FROM admini  ORDER BY aID DESC;");
                                    ...
                                    <div class='card-body pt-4 p-3'>
                                            ...
                                            <tr>
                                                ...
                                                <li class='list-group-item border-0 d-flex p-1 mb-2 bg-gray-100 border-radius-lg'>
                                                    ...
                                                    <h6 class='mb-2 text-sm' style='font-weight: 800;'><?php echo $row['emri']."&nbsp;".$row['mbiemri']; ?></h6>
                                                    <span class='mb-0'  style='font-size: 12px; font-weight: 500;'>ID: <?php echo $row['adminID']; ?></span>
                                                    <span class='mb-0 text-xs'  style='font-size: 12px; font-weight: 500;'>User: <?php echo $row['usernamee']; ?></span>
                                                    <span class='mb-0 text-xs'  style='font-size: 12px; font-weight: 500;'>Nr.tel: <?php echo $row['nrtel']; ?></span>
                                                    <span class='mb-2 text-xs'  style='font-size: 12px; font-weight: 500;'>Komuna: <?php echo $row['komuna']; ?></span>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <button type="button" style='font-size: 13px;' class="btn btn-danger d-flex " data-bs-toggle="modal" data-bs-target="#fshijModal<?php echo $row["adminID"];?>"><span style='font-size: 16px;' class="material-symbols-outlined text-xs">delete</span> Fshij</button>
                                                        </div>
                                                        <div class="col-6">
                                                            <button  style='font-size: 13px;' class="btn btn-primary  d-flex" data-bs-toggle="modal" data-bs-target="#editModal<?php echo $row["adminID"];?>"><span style='font-size: 16px;' class="material-symbols-outlined text-xs">edit</span> Ndrysho</button>
                                                        </div>
                                                    </div>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="modal fade" id="fshijModal<?php echo $row["adminID"];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel12" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Dëshironi të fshini zyrtarin !
                                            </div>
                                            <div class="modal-footer">
                                              <button type="button" class="btn btn-outline-default" data-bs-dismiss="modal">Anulo</button>
                                              <a href="func/fshijadmin.php?pid=<?php echo $row["adminID"];?>" class="btn btn-primary">Fshij Tani</a>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="modal fade modali004" id="editModal<?php echo $row["adminID"];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel1">Ndrysho Zyrtarin</h5>
                                                <button type="button" class="close h5" style="outline: none;border: none;background-color: transparent;" data-bs-dismiss="modal" aria-label="Close">
                                                  <span aria-hidden="true">&times;</span>
                                                </button>
                                              </div>
                                              <div class="modal-body">
                                                ...
                                                <p style="font-size: 12px;" class='text-xs text-danger text-bold error' ></p>
                                                  ...
                                                  <div class="mb-2">
                                                    <input type="text" class="form-control username"  name="ndryshombi" placeholder="Mbiemri" value="<?php echo $row["mbiemri"];?>" />
                                                  </div>
                                                  <div class="mb-2">
                                                    <input type="text" class="form-control username"  name="ndryshouser" placeholder="Username" value="<?php echo $row["usernamee"];?>"/>
                                                  </div>
                                                  <div class="mb-2">
                                                    <input type="text" class="form-control username"  name="ndryshonrtel" placeholder="Numri Telefonit" value="<?php echo $row["nrtel"];?>" />
                                                  </div>
                                                  <div class="mb-2">
                                                    <input type="text" class="form-control username"  name="ndryshoemail" placeholder="Email" value="<?php echo $row["email"];?>" />
                                                  </div>
                                                  <div class="mb-2">
                                                  ...
                                                  <div class="mb-3 qmimi">
                                                    <input  type="hidden" class="form-control usi1 username"  name="uniqe" value="<?php echo $row["adminID"];?>" />
                                                  </div>
                                                  <div class="modal-footer">
                                                    <button type="button" class="btn btn-outline-default" data-bs-dismiss="modal">Anulo</button>
