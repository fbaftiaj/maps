...
<body>
    ...
    <?php
        $query = mysqli_query($connect, "SELECT * FROM kompania WHERE komID = '$admin'");
...
<div class="row">
  <div class="profile-nav col-md-3">
      <div class="panel">
          <div class="user-heading round " style="padding: 7rem 0;">
              ...
              <p class="text-primary"><?php echo $fetch['komuna']?></p>
          </div>
      </div>
  </div>
  ...
  <div class="profile-info col-md-9">
      ...
      <div class="panel">
          ...
          <div class="panel-body mt-3 bio-graph-info">
              ...
              <div class="row rowii">
                  ...
                  <div class="bio-row">
                      <p><span>Data e regjistrimit</span>: <?php echo $date;?></p>
                  </div>
                  <div class="bio-row">
      ...
      <?php 
      $query1 = mysqli_query($connect, "SELECT * FROM kordinata;");
      $query2 = mysqli_query($connect, "SELECT * FROM kordinata WHERE komID = '$admin' AND statusi = 'perfunduar';");
